...
hx::Object *Sound_obj::__ToInterface(const type_info &inType) {
	if (inType==typeid( ::com::ktxsoftware::kje::Sound_obj)) return operator ::com::ktxsoftware::kje::Sound_obj *();
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("com.ktxsoftware.kje.backend.cpp.Sound"), hx::TCanCast< Sound_obj> ,sStaticFields,sMemberFields,
