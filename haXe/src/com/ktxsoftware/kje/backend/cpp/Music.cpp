...
hx::Object *Music_obj::__ToInterface(const type_info &inType) {
	if (inType==typeid( ::com::ktxsoftware::kje::Music_obj)) return operator ::com::ktxsoftware::kje::Music_obj *();
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("com.ktxsoftware.kje.backend.cpp.Music"), hx::TCanCast< Music_obj> ,sStaticFields,sMemberFields,
