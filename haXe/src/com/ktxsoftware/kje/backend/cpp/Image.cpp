...
hx::Object *Image_obj::__ToInterface(const type_info &inType) {
	if (inType==typeid( ::com::ktxsoftware::kje::Image_obj)) return operator ::com::ktxsoftware::kje::Image_obj *();
	return super::__ToInterface(inType);
}

int Image_obj::getWidth( ){
	HX_SOURCE_PUSH("Image_obj::getWidth")
	HX_SOURCE_POS("src/com/ktxsoftware/kje/backend/cpp/Image.hx",8)
...
int Image_obj::getHeight( ){
	...
	HX_SOURCE_POS("src/com/ktxsoftware/kje/backend/cpp/Image.hx",12)
...
bool Image_obj::isAlpha( int x,int y){
	...
	HX_SOURCE_POS("src/com/ktxsoftware/kje/backend/cpp/Image.hx",16)
	return true;
}
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("com.ktxsoftware.kje.backend.cpp.Image"), hx::TCanCast< Image_obj> ,sStaticFields,sMemberFields,
